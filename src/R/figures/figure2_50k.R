...
ggsave(file = "figs/figure2_wui_50k.eps", g, width = 5, height = 9, dpi=1200) #saves g
ggsave(file = "figs/figure2_wui_50k.tiff", g, width = 5, height = 9, dpi=1200) #saves g

legend <- g_legend(p1) 
ggsave(file = "figs/figure2a_wui_50k_legend.eps", 
       legend, width = 2, height = 4.5, dpi=1200) #saves g
legend <- g_legend(p2) 
ggsave(file = "figs/figure2b_wui_50k_legend.eps", 
       legend, width = 2, height = 4.5, dpi=1200) #saves g
legend <- g_legend(p3) 
ggsave(file = "figs/figure2c_wui_50k_legend.eps", 
       legend, width = 2, height = 4.5, dpi=1200) #saves g
...
ggsave(file = "figs/figureS2_vldwild_50k.eps", g, width = 12, height = 9, dpi=1200) #saves g
ggsave(file = "figs/figureS2_vldwild_50k.tiff", g, width = 12, height = 9, dpi=1200) #saves g

legend <- g_legend(p1) 
ggsave(file = "figs/figureS2a_vldwild_50k_legend.eps", 
       legend, width = 2, height = 4.5, dpi=1200) #saves g
legend <- g_legend(p2) 
ggsave(file = "figs/figureS2b_vldwild_50k_legend.eps", 
       legend, width = 2, height = 4.5, dpi=1200) #saves g
legend <- g_legend(p3) 
ggsave(file = "figs/figureS2c_vldwild_50k_legend.eps", 
       legend, width = 2, height = 4.5, dpi=1200) #saves g