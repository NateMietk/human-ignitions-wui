...
ggsave(file.path(main_text_figs, "figure4_wmean.tiff"), g, width = 6, height = 8, dpi=1200)
...
grid.arrange(firefreq_west, firefreq_cent, firefreq_se, firefreq_ne, ncol =2)
g <- arrangeGrob(firefreq_west, firefreq_cent, firefreq_se, firefreq_ne, ncol =2)
ggsave(file.path(main_text_figs, "figure4.tiff"), g, width = 6, height = 8, dpi=1200)
